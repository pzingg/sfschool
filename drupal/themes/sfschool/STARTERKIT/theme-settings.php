...
// Include the definition of sfschool_settings() and sfschool_theme_get_default_settings().
include_once './' . drupal_get_path('theme', 'sfschool') . '/theme-settings.php';
...
function STARTERKIT_settings($saved_settings) {
  ...
  $defaults = sfschool_theme_get_default_settings('STARTERKIT');
